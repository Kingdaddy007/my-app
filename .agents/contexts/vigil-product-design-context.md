...
Primary platform: Android. Current active implementation: Expo 57, React Native 0.86, TypeScript, Expo Router, and local SQLite. The three PNG boards in the repository are mandatory visual references and a quality floor, not final layouts.
