...
7. The current codebase is Expo/React Native, not Flutter. Continue this implementation unless the owner explicitly authorizes a separate Flutter rewrite.
