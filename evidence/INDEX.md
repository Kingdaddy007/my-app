...
| **A06** | Label pause as Rest: in-place reclassification without duplicate interval | `tests/timeEngine.test.ts` (`A06: Label Pause as Rest`) | **PASS** | `evidence/test_run_results.txt` |
...
| **A12** | Priorities saved, marked complete, reordered, maximum three per day | `tests/insightsAndPriorities.test.ts` (`A12: Priorities saved`) | **PASS** | `evidence/test_run_results.txt` |
